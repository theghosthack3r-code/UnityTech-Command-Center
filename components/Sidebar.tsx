...
export const Sidebar: React.FC<{
  ...
  const sidebarContent = (
    <div className="flex h-full w-72 flex-col border-r border-border bg-card">
        <div className="flex h-25 shrink-0 items-center justify-center border-b border-border px-6">
             <img src="https://i.postimg.cc/YSr5M2GM/UTS-CC-Logo.webp" alt="AI Command Logo" className="h-22" />
        </div>
